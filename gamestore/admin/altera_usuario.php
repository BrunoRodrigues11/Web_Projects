...
if($_POST){
    ...
    $resultado  = $conn_gamestore->query($updateSQL);
        ...
        <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
            ...
            <div class="thumbnail">
                <div class="alert alert-info" role="alert">
                    <form action="altera_usuario.php" name="form_altera_usuario" id="form_altera_usuario" method="post" enctype="multipart/form-data">
                    ...
                    <!-- input login_usuario-->
                        ...
                        <div class="input-group">
                            ...
                            <label class="radio-inline" for="nivel_usuario_s">
                                <input type="radio" name="nivel_usuario" id="nivel_usuario" value="sup" <?php echo $row['nivel_usuario']=="sup" ? "checked" : null; ?> >SuperUser
                            </label>
                        </div>
                        <br>
                        <!-- btn enviar -->
