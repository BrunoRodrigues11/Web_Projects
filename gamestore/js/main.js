...
// Icone FAV 
$(document).ready(function () {
    $("#fav").on("hide.bs.collapse", function () {
        $(".btnfav").html('<span class="glyphicon glyphicon-heart-empty"></span> Fav');
    });
    $("#fav").on("show.bs.collapse", function () {
        $(".btnfav").html('<span class="glyphicon glyphicon-heart"></span> Fav');
    });
});
